...
Blockly.ESP32.myNodesCode = function (block) {
    // console.log(block);
    //window.alert("myNodesCode"+block);
    let  strFieldValue = '';
    ...
    //window.alert("myNodesCode"+strFieldValue);
...
//window.alert("finish a=="+a);
    ...
    d.length && d.push("\n");
    //window.alert("Blockly.Workspace.prototype.variableList.length=="+Blockly.Workspace.prototype.variableList.length);
    //window.alert(Blockly.Workspace.prototype.variableList[1]);
    //window.alert(Blockly.Workspace.prototype.variableList[2]);

    for (f in Blockly.Workspace.prototype.variableList) 
    vars.push(intVar + Blockly.Workspace.prototype.variableList[f] + " = " + (Blockly.Workspace.prototype.variableValueList[f] ? Blockly.Workspace.prototype.variableValueList[f] : '0') + endColon);
    ...
    for (f in Blockly.ESP32.definitions_){ window.alert("Blockly.ESP32.definitions_[f]=="+Blockly.ESP32.definitions_[f]); c.push(Blockly.ESP32.definitions_[f]);}
    c.length && c.push("\n");
    for (f in Blockly.ESP32.codeFunctions_) { window.alert("Blockly.ESP32.codeFunctions_[f]=="+Blockly.ESP32.codeFunctions_[f]); e.push(Blockly.ESP32.codeFunctions_[f]);}
...
////    xx = Blockly.getMainWorkspace();
////    this.init(xx);
////    var zz=xx.getTopBlocks(!0);
////    window.alert("zz=="+zz.length);
...
{
//window.alert("Add var in code a=="+a+" b=="+b+"  c=="+c);
//window.alert("Blockly.ESP32.variables_[a]=="+Blockly.ESP32.variables_[a]);
//window.alert(b);
//window.alert(c);
//window.alert(d);
    var d = !1;
    if (c || void 0 === Blockly.ESP32.variables_[a]) 
    Blockly.ESP32.variables_[a] = b, d = !0;
        return d
